...
LangString javaNeeded ${LANG_ROMANIAN} "JClic solicita actualizarea motorului Java, la versiunea 1.7 sau mai noua. Se poate descarca de la  http://www.java.com"
...
LangString oldJavaMsg ${LANG_ROMANIAN} "Pe calculatorul dvs. este instalată o versiune veche de Java."
...
LangString noJavaMsg ${LANG_ROMANIAN} "Este imposibil să gasesc limbajul JAVA pe acest calculator."
...
LangString standardType ${LANG_ROMANIAN} "Standard"
...
LangString fullType ${LANG_ROMANIAN} "Complect"
...
LangString liteType ${LANG_ROMANIAN} "Minimal"
...
LangString captionStr ${LANG_ROMANIAN} "JClic ${PRODUCT_VERSION} setare offline"
...
LangString JClicPlayerDesc ${LANG_ROMANIAN} "Aplicatie ce rureaza activitati JClic."
...
LangString JClicAuthorDesc ${LANG_ROMANIAN} "Aplicație de creare și editare activitati JClic."
...
LangString JClicAppletDesc ${LANG_ROMANIAN} "Fisiere necesare doar pe un server cu applet-uri JClic gazduite."
...
LangString JClicReportsDesc ${LANG_ROMANIAN} "Server de rapoarte."
