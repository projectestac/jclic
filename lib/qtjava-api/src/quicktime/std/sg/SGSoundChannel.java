...
public final class SGSoundChannel extends AudioChannel
{
    ...
    public SGSoundChannel(SequenceGrabber sequencegrabber) throws StdQTException {super(sequencegrabber, 0);}
    public void setSoundInputRate(float f) throws StdQTException {}
    public void setSoundInputParameters(int i, int j, int k) throws StdQTException {}
