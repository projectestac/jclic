...
public class RiffFile
{
   ...
   public static int FourCC(String ChunkName)
   {
	...
	//  int ret = (((p[0] << 24)& 0xFF000000) | ((p[1] << 16)&0x00FF0000) | ((p[2] << 8)&0x0000FF00) | (p[3]&0x000000FF));
      ...
      return ((((byte)(ChunkName.charAt(0)) << 24)& 0xFF000000) | (((byte)(ChunkName.charAt(1)) << 16)&0x00FF0000) | (((byte)(ChunkName.charAt(2)) << 8)&0x0000FF00) | ((byte)(ChunkName.charAt(3))&0x000000FF));      
   }
