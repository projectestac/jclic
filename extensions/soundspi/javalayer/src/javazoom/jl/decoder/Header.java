/*
 * 12/08/13 : Modified by fbusquets: change StringBuffer by StringBuilder
 * 
 *
...
public final class Header
{
	...
	public String toString()
	{
		...
		.append(' ').append(version_string());
		if (!checksums())
			buffer.append(" no");
		buffer.append(" checksums").append(' ').append(sample_frequency_string())
		.append(',').append(' ').append(bitrate_string());
