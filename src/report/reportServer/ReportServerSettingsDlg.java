...
public class ReportServerSettingsDlg extends JDialog implements ReportServerConstants {
  ...
  private void initComponents() {
    ...
    pwdField =
        new javax.swing.JPasswordField(
            options.getString(ConnectionBeanProvider.DB_PASSWORD, ""), 20);
    ...
    logFileWebBtn.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void logFileWebBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_logFileWebBtnActionPerformed
  ...
  private void tooltipChkActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_tooltipChkActionPerformed
