...
public class ReportServer extends javax.swing.JFrame implements ReportServerConstants, ResourceBridge {
  ...
  public ReportServer(String[] args) {
    ...
    if (cfgFile == null || !cfgFile.exists())
      cfgFile = new File(
          edu.xtec.util.PersistentSettings.getFilePath(edu.xtec.jclic.Constants.PROGRAM, CFG_FILE, options, true));
  ...
  private void initComponents() { // GEN-BEGIN:initComponents
    ...
    launchBrowserBtn
        .setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/browser_small.gif")));
  ...
  private void launchBrowserBtnActionPerformed(java.awt.event.ActionEvent evt) { // GEN-FIRST:event_launchBrowserBtnActionPerformed
    ...
    try {
      java.net.URL page = new java.net.URL("http", java.net.InetAddress.getLocalHost().getHostName(), httpPort, "/");
