 ...
 * @version 13.09.17
 */
public class ReportServer extends javax.swing.JFrame implements ReportServerConstants, ResourceBridge {
    ...
    public ReportServer(String[] args) {
        ...
        if(args.length>0 && args[0]!=null){
            ...
            if(!cfgFile.isAbsolute())
                cfgFile=new File(System.getProperty("user.dir"), args[0]);
        }
        if(cfgFile==null || !cfgFile.exists())
            cfgFile=new File(edu.xtec.util.PersistentSettings.getFilePath(edu.xtec.jclic.Constants.PROGRAM, CFG_FILE, options, true));
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        startWebServerBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/run.gif")));
        startWebServerBtn.setToolTipText(msg.get("form_btn_start_tooltip"));
        startWebServerBtn.setText(msg.get("form_btn_start"));
        startWebServerBtn.addActionListener(new java.awt.event.ActionListener() {
        ...
        stopWebServerBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/cancel.gif")));
        stopWebServerBtn.setToolTipText(msg.get("form_btn_stop_tooltip"));
        stopWebServerBtn.setText(msg.get("form_btn_stop"));
        stopWebServerBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        launchBrowserBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/browser_small.gif")));
        launchBrowserBtn.setText(msg.get("form_btn_show"));
        launchBrowserBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        webClearTextBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/delete.gif")));
        webClearTextBtn.setToolTipText(msg.get("form_messages_clear_tooltip"));
        webClearTextBtn.setText(msg.get("form_messages_clear"));
        webClearTextBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        webCopyTextBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/copy.gif")));
        webCopyTextBtn.setToolTipText(msg.get("form_messages_copy_tooltip"));
        webCopyTextBtn.setText(msg.get("form_messages_copy"));
        webCopyTextBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        settingsButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/settings.gif")));
        ...
        aboutBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/about_small.gif")));
        ...
        exitBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/exit_small.gif")));
    ...
    private void webClearTextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_webClearTextBtnActionPerformed

        webMsgTextArea.setText("");
        
    }//GEN-LAST:event_webClearTextBtnActionPerformed

    private void webCopyTextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_webCopyTextBtnActionPerformed
    ...
    private void launchBrowserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_launchBrowserBtnActionPerformed

        try{            
            java.net.URL page=new java.net.URL("http", 
            java.net.InetAddress.getLocalHost().getHostName(), httpPort, "/");
    ...
    private void stopWebServerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stopWebServerBtnActionPerformed

        stopWebServer();
        
    }//GEN-LAST:event_stopWebServerBtnActionPerformed

    private void startWebServerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startWebServerBtnActionPerformed
  ...
  /** Exit the Application */
    ...
    protected void showAbout(){
        ...
        try{
            aw.buildAboutTab("JClic Reports", getMsg("REPORTS_VERSION"), "logo_reports_small.png", null, null, null, null);
