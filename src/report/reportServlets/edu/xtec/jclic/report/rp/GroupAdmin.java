...
public class GroupAdmin extends Basic {
  ...
  public static final int MENU = 0, GROUP_MENU = 1, EDIT = 2, EDIT_UPDATE = 3, CREATE = 4, CREATE_UPDATE = 5,
      DELETE = 6, DELETE_UPDATE = 7, CLEAR = 8, CLEAR_UPDATE = 9, ERR = 10;

  public static final String[] ACTIONS = { "", "group", "edit", "editUpd", "create", "createUpd", "del", "delUpd",
      "clear", "clearUpd" };
  ...
  public boolean init() throws Exception {
    ...
    else if (page == GROUP_MENU && gd != null)
      users = bridge.getUsers(gd.getId());
  ...
  protected void edit() throws Exception {
    ...
    if (name.length() == 0)
      errMsg = errMsg + getMsg("group_admin_invalid_name");
    else {
      gd.setText(name);
  ...
  protected void create() throws Exception {
    ...
    if (name.length() == 0)
      ...
      errMsg = errMsg + getMsg("group_admin_invalid_id");
    else {
  ...
  public void body(java.io.PrintWriter out) throws Exception {
    ...
    if (page != MENU)
      sb.append(" | ").append(linkTo(getUrl(), getMsg(TITLE), null));
    ...
    case GROUP_MENU:
      ...
      sb.append("<p><strong>").append(getMsg("group_admin_id")).append("</strong> ").append(filter(gd.getId()))
          .append("</p>\n");
      sb.append("<p><strong>").append(getMsg("group_admin_name")).append("</strong> ").append(filter(gd.getText()))
          .append("</p>\n");
      ...
      if (users != null && users.size() > 0) {
        ...
        while (it.hasNext()) {
          ...
          sb.append("<tr><td><a href=\"").append(sb2.substring(0)).append("\">").append(filter(ud.getText()));
          sb.append("</a></td></tr>\n");
        }
        sb.append("</table>\n");
        sb.append("<br clear=\"all\">");
    ...
    case DELETE:
      sb.append("<p><strong>").append(getMsg("group_admin_delete_group")).append(" \"").append(filter(gd.getText()))
          .append("\"</strong></p>\n");
    ...
    case CLEAR:
      sb.append("<p><strong>").append(getMsg("group_admin_clear_group")).append(" \"").append(filter(gd.getText()))
          .append("\"</strong></p>\n");
