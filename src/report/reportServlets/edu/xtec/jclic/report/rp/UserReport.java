...
public class UserReport extends Report{
    ...
    public void body(java.io.PrintWriter out) throws Exception{
        ...
        zona(sb, "report_group", GROUP, true, opcioDefecte, 
        vectorToArray(groups, true), groupId, isEditable, 180);        
        zona(sb, "report_user", USER, true, opcioDefecte, 
        vectorToArray(users, true), userId, isEditable, 180);
        zona(sb, "report_project", PROJECT, true, opcioDefecte, 
        vectorToArray(projects, false, WILDCARD, "report_all_projects"), 
        projectName, isEditable, 180);
        sb.append("</div>\n");
