...
public interface Constants {
  ...
  /**
   * Key for the parameter <CODE>exitUrl</CODE>, used in applets to specify the URL where the
   * browser should navigate when JClic executes an <CODE>exit</CODE> command.
   */
  public static final String EXIT_URL = "exitUrl";

  /**
   * Key for the parameter <CODE>urlBase</CODE>, used in applets to specify the absolute base URL
   * used to locate other files.
   */
  public static final String URL_BASE = "urlBase";

  /**
   * Key for the parameter <CODE>infoUrlFrame</CODE>, used in applets to specify the name of the
   * browser frame or window where the <CODE>info</CODE> content of the activities will be
   * displayed.
   */
  public static final String INFO_URL_FRAME = "infoUrlFrame";

  /**
   * Key for the boolean parameter <CODE>compressImages</CODE>. When <CODE>false</CODE>, images
   * larger than the cell will be cropped. Otherwise, JClic will compress it to fit into the cell.
   */
  public static final String COMPRESS_IMAGES = "compressImages";

  /**
   * Key for the boolean parameter 'preDrawImages', used in past versions to activate a workaround
   * to a Java graphics bug.
   */
  public static final String PRE_DRAW_IMAGES = "preDrawImages";

  /**
   * Key for the parameter 'skin', used to specify the {@link edu.xtec.jclic.skins.Skin} to be used.
   */
  public static final String SKIN = "skin";

  /**
   * Key for the parameter 'reporterClass', used to specify the type of {@link
   * edu.xtec.jclic.report.Reporter} to be used.
   */
  public static final String REPORTER_CLASS = "reporter";

  /** Key for the parameter 'reporterParams', used to pass specific parametres to the reporter. */
  ...
  /**
   * Key for the boolean parameter 'audioEnabled'. When <CODE>false</CODE>, no sounds or other media
   * are played.
   */
  public static final String AUDIO_ENABLED = "audioEnabled";

  /**
   * Key for the boolean parameter 'navButtonsAlways'. When <CODE>true</CODE>, the navigation
   * buttons (<I>next activity</I> and <I>previous activity</I>) are always displayed.
   */
  public static final String NAV_BUTTONS_ALWAYS = "navButtonsAlways";

  /**
   * Key for the boolean parameter 'trace'. When <CODE>true</CODE>, debug messages are displayed in
   * the console.
   */
  public static final String TRACE = "trace";

  /**
   * Key for the boolean parameter 'myurl'. Used by applets to know its DocumentBase since Oracle
   * has broken this funcionality for local filesystems in Java 1.7.40.
   */
  ...
  /**
   * Key for the runtime property <CODE>mediaSystem</CODE>. Possible values are <CODE>JMF</CODE>,
   * <CODE>QT</CODE>, <CODE>QT61</CODE> or <CODE>null</CODE>.
   */
  public static final String MEDIA_SYSTEM = "mediaSystem";

  /**
   * Key for the parameter or runtime property 'noMediaSystemWarn', used to indicate that users
   * should not be warned about the absence of multimedia extensions in their Java system.
   */
  ...
  /**
   * Index of the <CODE>ok</CODE> cursor in the {@link edu.xtec.jclic.Player} member <CODE>cursors
   * </CODE>.
   */
  ...
  /**
   * Index of the <CODE>record</CODE> (microphone) cursor in the {@link edu.xtec.jclic.Player}
   * member <CODE>cursors</CODE>.
   */
   ...
   */
  public static final int[] DYNAMIC_ACTIONS = {
    ACTION_PREV, ACTION_NEXT, ACTION_RETURN, ACTION_RESET, ACTION_INFO, ACTION_HLP
  };
  /**
   * Array with the names of all the dynamic actions used in {@link edu.xtec.jclic.Player} objects.
   */
  public static final String[] ACTION_NAME = {
    "prev", "next", "return", "reset", "info", "help", "audio", "about"
  };
  ...
  /**
   * Number of counters used in JClic players (currently 3: <CODE>score</CODE>, <CODE>actions</CODE>
   * and <CODE>time</CODE>)
   */
  ...
  public static final int T_ACTIVITY = 0x0001,
      T_SEQUENCE = 0x0002,
      T_URL = 0x0004,
      T_EXTERNAL = 0x0008,
      T_IMAGE = 0x0010,
      ...
      T_CLIC = 0x1000,
      T_INST = 0x2000,
      T_UNKNOWN_MEDIA = 0x4000,
      T_TEXT = 0x8000;

  /** Generic value used to represent all the supported media types. */
  public static final int T_MEDIA =
      T_IMAGE | T_AUDIO | T_MIDI | T_VIDEO | T_ANIM | T_XML | T_FONT | T_UNKNOWN_MEDIA;
}
