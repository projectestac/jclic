...
public class BoxConnector extends Object {
  ...
  public void drawLine(Graphics2D g2) {
    if (active)
      drawLine(g2, origin, dest, arrow, lineColor, xorColor, arrow_l, arrow_angle, line_width);
  }
  ...
  public void end() {
    ...
    if (bx != null) {
      ...
      growRect(r, 1, 1);
      parent.repaint(r);
      bx.setLocation(origin.getX() - relativePos.getX(), origin.getY() - relativePos.getY());
      bx.setTemporaryHidden(false);
