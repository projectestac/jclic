...
public abstract class AbstractBox extends Rectangle2D.Double implements Cloneable {
    ...
    public Object clone(){
        ...
        if(hostedComponent!=null){
            if(hostedComponent instanceof JLabel){
                ...
                bx.hostedComponent=new JLabel(lb.getText(), lb.getIcon(), 
        ...
        if(!bb.transparent){
            if(bb.bgGradient==null || bb.bgGradient.hasTransparency()){
                g2.setColor(inactive 
                            ? bb.inactiveColor 
                            : inverted ? bb.textColor : bb.backColor);
                g2.fill(shape);
    ...
    public boolean isTemporaryHidden() {return temporaryHidden;}
    ...
    private void setHostedComponentColors(){
        if(hostedComponent!=null){
            ...
            hostedComponent.setBackground(inactive ? bb.inactiveColor 
                                          : inverted ? bb.textColor 
                                          : bb.backColor);
            hostedComponent.setForeground(inverted ? bb.backColor 
                                          : alternative ? bb.alternativeColor 
                                          : bb.textColor);
    ...
    private void setHostedComponentBorder(){
        if(hostedComponent!=null && hostedComponent instanceof JComponent){
            ((JComponent)hostedComponent).setBorder(
            border
