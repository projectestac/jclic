...
public class FontCheck {
    ...
    public static final String[] fontSizes=new String[] {
    ...
    public static Font buildNewFont(String fileName, StreamIO.InputStreamProvider isp, String resourceName) throws Exception{
        ...
        // Only available in Java 1.6 or later
        // Code for Java 6 will be:
        // java.awt.GraphicsEnvironment.getLocalGraphicsEnvironment().registerFont(font);
        //
        // By now... check if method "registerFont" exists, so we are in java 1,6 or later,
        // and then invoke it
        //

        Font font=null;
        Class cl=GraphicsEnvironment.class;
        Method m=cl.getMethod("registerFont", new Class[]{Font.class});
        if(m!=null){
            // We are running on Java 1.6 or later. Go ahead!
            GraphicsEnvironment ge=GraphicsEnvironment.getLocalGraphicsEnvironment();
            font=Font.createFont(Font.TRUETYPE_FONT, isp.getInputStream(resourceName));
            if(font!=null){
                m.invoke(ge, new Object[]{font});
