...
public class CheckOptionsPanel extends javax.swing.JPanel {
  ...
  private void initComponents() { // GEN-BEGIN:initComponents
    ...
    btnPanel.setBorder(
        new javax.swing.border.TitledBorder(options.getMsg("edit_text_act_checkButton")));
    checkButtonChk.setText(options.getMsg("edit_text_act_checkButton_show"));
    checkButtonChk.addActionListener(
  ...
  private void checkButtonChkActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_checkButtonChkActionPerformed
  ...
  public void setOptions(TextActivityBase tab) {
    ...
    if (s == null || s.length() < 1) s = options.getMsg("edit_text_act_defaultCheckButtonText");
