...
public class FillInBlanksCheckPanel extends javax.swing.JPanel {
  ...
  private void initComponents() { // GEN-BEGIN:initComponents
    ...
    progressPanel.setBorder(
        new javax.swing.border.TitledBorder(options.getMsg("edit_text_act_checkProgress")));
  ...
  public void setOptions(FillInBlanks fib) {
    ...
    if (fib.ev instanceof BasicEvaluator) basicPanel.setEvaluator((BasicEvaluator) fib.ev);
    if (fib.ev instanceof ComplexEvaluator) complexPanel.setEvaluator((ComplexEvaluator) fib.ev);
  }
  ...
  public void collectData(FillInBlanks fib) {
    ...
    if (fib.ev instanceof BasicEvaluator) basicPanel.collectData((BasicEvaluator) fib.ev);
    if (fib.ev instanceof ComplexEvaluator) complexPanel.collectData((ComplexEvaluator) fib.ev);
  }
