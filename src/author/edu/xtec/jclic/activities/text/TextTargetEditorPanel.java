...
public class TextTargetEditorPanel extends javax.swing.JPanel
    implements java.beans.PropertyChangeListener, java.awt.event.ActionListener, Resizer.ResizerListener {
  ...
  protected static final int[] popValues = { TextTarget.NO_INFO, TextTarget.INFO_ALWAYS, TextTarget.INFO_ON_ERROR,
      TextTarget.INFO_ON_DEMAND };
  ...
  /*
   * public boolean isModified(){ return modified || answerListEditor.isModified()
   * || listEditor.isModified(); }
   * 
   * public void setModified(boolean value){ modified=value; if(value)
  ...
  public void collectData() {
    if (textTarget != null /* && isModified() */) {
      ...
      /*
       * textTarget.infoMode = popupAlwaysOption.isSelected() ? TextTarget.INFO_ALWAYS
  ...
  public void editObject(Rectangle r, JComponent jc, Point pt) {
    if (jc == jpab) {
      ActiveBoxContent abc = ActiveBoxContentEditor.getActiveBoxContent(jpab.ab.getContent(), jpab, options, mbe,
          jpab.ab);
      if (abc != null) {
