...
public class OrderTypePanel extends javax.swing.JPanel {
  ...
  Options options;
  protected static final Map<Options, OrderTypePanel> panels =
      new HashMap<Options, OrderTypePanel>(1);
  ...
  private void initComponents() { // GEN-BEGIN:initComponents
    ...
    orderParagraphsBtn.addActionListener(
    ...
    orderWordsBtn.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void orderParagraphsBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_orderParagraphsBtnActionPerformed

    amongstParChk.setEnabled(!orderParagraphsBtn.isSelected());
  } // GEN-LAST:event_orderParagraphsBtnActionPerformed

  private void orderWordsBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_orderWordsBtnActionPerformed
