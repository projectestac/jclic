...
public class OrderCheckPanel extends javax.swing.JPanel {
  ...
  public void setOptions(Order ord) {
    ...
    if (ord.ev instanceof BasicEvaluator) basicPanel.setEvaluator((BasicEvaluator) ord.ev);
  }

  public void collectData(Order ord) {
    optionsPanel.collectData(ord);
    if (ord.ev instanceof BasicEvaluator) basicPanel.collectData((BasicEvaluator) ord.ev);
  }
