...
public class EditableShapeConstants {
  ...
  public static java.awt.Color ACTIVE_COLOR =
      new java.awt.Color(128, 128, 255); // When the polygon can be modified
  public static java.awt.Color SELECTED_BORDER_COLOR =
      java.awt.Color.orange; // When there is a point selected
