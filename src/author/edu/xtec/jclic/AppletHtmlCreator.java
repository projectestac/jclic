...
public class AppletHtmlCreator extends javax.swing.JPanel implements ActionListener {
  ...
  public static void createHtml(JClicProject prj, AuthorSettings settings, Component parent) {
    ...
    if (panel == null) panel = new AppletHtmlCreator(options, settings);
    ...
    if (msg.showInputDlg(parent, panel, "applet_create_title")) {
      ...
      if (ps != null) optionalParams.append("\r\nsetExitUrl('").append(ps).append("');");
      ...
      if (fileName != null) {
        try {
          ...
          sb.setLength(0);
          if (!full) {
            if (centered) sb.append("<div align=\"center\">");
            if (preApplet.length() > 0) sb.append(preApplet).append("<br>");
          }
          ...
          sb.setLength(0);
          if (!full) {
            if (postApplet.length() > 0) sb.append("<br>").append(postApplet);
            if (centered) sb.append("</div>");
          }
          ...
          if (msg.showQuestionDlgObj(
                  parent, prompt + "\n" + msg.get("applet_created_prompt"), null, "yn")
              == Messages.YES) {
