...
public class CopyActivityAttributesPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        javax.swing.JPanel actPanel;
        javax.swing.JScrollPane actScroll;
        ...
        actPanel.setBorder(new javax.swing.border.TitledBorder(options.getMsg("edit_act_copy_dest")));
    ...
    private CheckBoxTreeObject bgColor, bgGradient, bgImage, 
    activityBgColor, activityBgGradient, transparentBg, border, position, margin, 
    msgPrev, msgIni, msgEnd, msgErr, repInclude, repActions,
    skin, evSounds,
    cTime, maxTime, cTries, maxTries, cScore, scramble,
    helpBtn, infoBtn,
    gridA, gridB, textGrid,
    textFontFace, textFontSize, textStyle, textColour, targetColour, errorColour, tabSpace;
    ...
    private void copyAttributes(Activity srcAct, Activity targetAct){
        ...
        //messages
        if(msgPrev.isSelected() && srcAct.messages[Activity.PREVIOUS]!=null && targetAct.messages[Activity.PREVIOUS]!=null)
        ...
        if(msgErr.isSelected() && srcAct.messages[Activity.END_ERROR]!=null && targetAct.messages[Activity.END_ERROR]!=null)
        ...
        // Grids
        if(gridA.isSelected() 
        && srcAct.abc!=null && srcAct.abc.length>0 && srcAct.abc[0]!=null
        && targetAct.abc!=null && targetAct.abc.length>0 && targetAct.abc[0]!=null)
            srcAct.abc[0].copyStyleTo(targetAct.abc[0]);
        if(gridB.isSelected() 
        && srcAct.abc!=null && srcAct.abc.length>1 && srcAct.abc[1]!=null
        ...
        if(srcAct instanceof TextActivityBase && targetAct instanceof TextActivityBase){
            ...
            if(textFontFace.isSelected() || textFontSize.isSelected() 
            || textStyle.isSelected() || textColour.isSelected() 
            || targetColour.isSelected() || errorColour.isSelected()
            || tabSpace.isSelected()){
                StyleContext sc=TextActivityDocument.copyStylesFrom(
