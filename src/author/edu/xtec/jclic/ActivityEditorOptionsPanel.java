...
public class ActivityEditorOptionsPanel extends ActivityEditorInternalPanel {
  ...
  private void initComponents() {
    ...
    skinCombo =
        new javax.swing.JComboBox<Object>(edu.xtec.jclic.skins.Skin.getSystemSkinList(true));
    ...
    descScroll.setHorizontalScrollBarPolicy(
  ...
  public void fillData() {
    ...
    if (s.startsWith(Activity.BASE_CLASS_TAG)) s = s.substring(1);
    className.setText(s);
    ...
    evSoundsBtn.setMediaBagEditor(
        act == null ? null : getActivityEditor().getProjectEditor().getMediaBagEditor());
    ...
    boolean helpSolution =
        act != null && (act.showSolution || act.helpMsg == null || act.helpMsg.length() == 0);
    helpBtnSolution.setSelected(helpSolution);
    helpBtnMsg.setSelected(!helpSolution);
    helpBtnMsgText.setText(act == null ? "" : act.helpMsg);

    int v = 0;
    if (act != null && act.infoUrl != null && act.infoUrl.length() > 0) v = 1;
    else if (act != null && act.infoCmd != null && act.infoCmd.length() > 0) v = 2;
  ...
  public void saveData() {
    ...
    if (act != null) {
      ...
      if (act.hasRandom()) act.shuffles = scrambleTimesInt.getValue();
  ...
  public boolean eventPerformed(EventObject ev) {
    ...
    if (cmp == chClassBtn && aed != null) {
      ...
      if ((result =
          getOptions().getMessages().showInputDlg(this, sac, "edit_act_changeType")
      ...
      if (acped != null) {
        if (acped.getAutoContentProvider().getShortClassName().equals(acpClassName)) return false;
      ...
      AutoContentProviderEditor acped =
          (AutoContentProviderEditor) aed.getFirstChild(AutoContentProviderEditor.class);
      if (acped != null) acped.editData(this, options);
    }
