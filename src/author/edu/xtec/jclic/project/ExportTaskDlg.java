...
"</manifest>";
  ...
  public static void doTask(ResourceBridge rb, AuthorSettings settings, Component parent,
          ...
          final JClicProject project, final boolean copyAll, final boolean exportScorm) {
    ...
    exportDlg.sw = new edu.xtec.util.SwingWorker() {
      ...
      public Object construct() {
        try {
          ...
          String scormFileName = null;
          if(exportScorm){
            final byte[] BUFFER = new byte[1024];
            int i=0;            
            scormFileName = mainFileName + ".scorm.zip";
            exportDlg.ps.println("Generating file \"" + scormFileName + "\" with all content inside");
            
            ZipOutputStream out = new ZipOutputStream(new FileOutputStream(new File(outputPath, scormFileName)));
