    ...
    exportDlg.sw = new edu.xtec.util.SwingWorker() {
      ...
      public Object construct() {
        try {
          ...
          s = StrUtils.replace(s, "%FAVICONICO%", project.settings.icon16 == null ? "favicon.ico" : project.settings.icon16);
          s = StrUtils.replace(s, "%ICON72PNG%", project.settings.icon72 == null ? "icon-72.png" : project.settings.icon72);
          s = StrUtils.replace(s, "%ICON192PNG%", project.settings.icon192 == null ? "icon-192.png" : project.settings.icon192);
