  ...
  private void initComponents() {
    ...
    licenseCombo =
        new javax.swing.JComboBox<String>(
            edu.xtec.jclic.project.ProjectSettings.getLicensesList(
                this.options.getMsg("settings_license_other")));
    ...
    skinCombo =
        new javax.swing.JComboBox<String>(edu.xtec.jclic.skins.Skin.getSystemSkinList(false));
  ...
  private void removeBtnActionPerformed(
    ...
    if (meta_langs.length > 1) {
      ...
      if (this.options
              ...
              .showQuestionDlg(
                  this,
                  "edit_project_languages_confirm_delete",
                  meta_langs[p].getDisplayName(),
                  "yn")
          == Messages.YES) {
        tabDesc.remove(p);
  ...
  protected void fillData() {
    ...
    for (int i = 0; i < levelChkBoxes.length; i++)
      levelChkBoxes[i].setSelected(
          ps != null
              && ps.level_codes != null
              && ps.level_codes.contains(ProjectSettings.KNOWN_LEVEL_CODES[i]));

    for (int i = 0; i < areaChkBoxes.length; i++)
      areaChkBoxes[i].setSelected(
          ps != null
              && ps.area_codes != null
              && ps.area_codes.contains(ProjectSettings.KNOWN_AREA_CODES[i]));
    ...
    licenseCombo.setSelectedIndex(
        ps == null ? edu.xtec.jclic.project.ProjectSettings.CC_BY_NC_SA : ps.license);
  ...
  */
  ...
  protected void saveData() {
    ...
    if (ps != null) {
      ...
      for (int i = 0; i < levelChkBoxes.length; i++)
        if (levelChkBoxes[i].isSelected()) ps.level_codes.add(ProjectSettings.KNOWN_LEVEL_CODES[i]);
      ps.level = StrUtils.nullableString(levelText.getText());

      ps.area_codes = new ArrayList<String>();
      for (int i = 0; i < areaChkBoxes.length; i++)
        if (areaChkBoxes[i].isSelected()) ps.area_codes.add(ProjectSettings.KNOWN_AREA_CODES[i]);
  ...
  private Object editLanguage(final Object currentValue, boolean newValue) {
    ...
    if (options
        ...
        .showInputDlg(
            this,
            new String[] {"edit_project_languages_select"},
            null,
  ...
  private Object editOrg(Object currentValue, boolean newValue) {
    ...
    if (options
        ...
        .showInputDlg(
            this,
            new String[] {"edit_project_org_info"},
            null,
            new JComponent[] {organizationEditPanel},
  ...
  private Object editRevision(Object currentValue, boolean newValue) {
    ...
    if (options
        ...
        .showInputDlg(
            this,
            new String[] {"edit_project_rev_info"},
            null,
            new JComponent[] {revisionEditPanel},
