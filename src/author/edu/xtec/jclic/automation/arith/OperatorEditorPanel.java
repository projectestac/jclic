...
public class OperatorEditorPanel extends edu.xtec.util.CtrlPanel {
  ...
  private void initComponents() {
    ...
    decPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(options.getMsg("edit_arith_op_decimals")));
  ...
  public void setOperator(Operator op) {
    ...
    if (op.numDec == 1) opDec1.setSelected(true);
    else if (op.numDec == 2) opDec2.setSelected(true);
    else opDec0.setSelected(true);
  ...
  public Operator getOperator() {
    ...
    if (opDec1.isSelected()) op.numDec = 1;
    else if (opDec2.isSelected()) op.numDec = 2;
    else op.numDec = 0;
    op.fromList = 0;
