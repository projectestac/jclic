...
public class TagReplaceEditorPanel extends EditorPanel {
  ...
  private void initComponents() {
    ...
    tagPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(options.getMsg("edit_tagRep_tags")));
    ...
    filePanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(options.getMsg("edit_tagRep_file")));
    ...
    charsetCombo.setModel(
        new javax.swing.DefaultComboBoxModel<Object>(
            new String[] {"UTF8", "UTF-16", "ISO8859_1", "ASCII"}));
  ...
  protected void selectTextFile() {
    ...
    if (tred != null) {
      ...
      if (act != null) {
        ...
        String[] files =
            fs.chooseFiles(null, false, filters, options, "edit_find_media", this, true, false);
