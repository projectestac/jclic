...
public class ActiveBoxContentEditor extends edu.xtec.util.CtrlPanel {
  ...
  public ActiveBoxContentEditor(
      Options options, ActiveBoxContent abc, MediaBagEditor mbe, ActiveBox ab) {
    ...
    if (eventsEnabled && src != null) {
      ...
      if (src == textArea) {
        ...
        if (!StrUtils.compareTrimStringsIgnoreCase(txt, abc.rawText)) {
          ...
          if (abc.bb != null) abc.bb.resetFont();
        }
      } else if (src == imgButton) {
        if (abc.imgName != null) abc.img = null;
        abc.imgName = imgButton.getImgName();
      } else if (src == borderChk) abc.border = borderChk.isSelected();
      ...
      if (preview != null) {
        BoxBase bb = abc.bb;
        if (resetPreviewFont && bb != null) bb.resetFont();
  ...
  public void setActiveBoxContent(ActiveBoxContent c) {
    if (c == null) c = new ActiveBoxContent();
    eventsEnabled = false;
    ...
    if (preview != null) preview.setCurrentContent(abc);
    eventsEnabled = true;
  }
  ...
  private void checkAndFirePropertyChange(ActiveBoxContent oldAbc) {
    ...
    boolean eq =
        ((oldAbc == null && currentAbc == null) || (oldAbc != null && oldAbc.equals(currentAbc)));
    if (!eq) firePropertyChange(PROP_ABC, oldAbc, currentAbc);
  }
  ...
  private static Map<Options, ActiveBoxContentEditor> panels =
      new HashMap<Options, ActiveBoxContentEditor>();

  public static ActiveBoxContent getActiveBoxContent(
      ActiveBoxContent initialAbc,
      Component parent,
      Options options,
      MediaBagEditor mbe,
      ActiveBox preview) {
    if (initialAbc == null) initialAbc = new ActiveBoxContent();
    ...
    if (preview != null) {
      ...
      if (abcOriginal != null) abcBackup = (ActiveBoxContent) abcOriginal.clone();
    }
  ...
  public static boolean nameChanged(
      ActiveBoxContent abc, int type, String oldName, String newName) {
