...
public class ActiveBagContentControlPanel extends edu.xtec.util.CtrlPanel {
  ...
  public ActiveBagContentControlPanel(ActiveBagContentEditor parent, int index, int altIndex, int visualIndex,
      boolean simpleMode) {
  ...
  private void initComponents() {
    ...
    shaperCombo = new javax.swing.JComboBox<Object>(
  ...
  public void fillData(Activity act) {
    ...
    scrambleChk.setSelected(act != null && (act.shuffleAlways()
        || (act.scramble != null && act.scramble.length > index ? act.scramble[index] : false)));
  ...
  private void toggleAltActionPerformed() {
    if (abc != null && !altNull && altAbc != null && parent.abcpp != null
