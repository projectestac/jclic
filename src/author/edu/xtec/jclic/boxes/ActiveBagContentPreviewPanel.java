                ...
                if(xbox!=null){
                    if(dragging){
                        ...
                        if(ab!=null){
                            ...
                            if(item>=0){
                                ActiveBoxContent abxc=ActiveBoxContentEditor.getActiveBoxContent(
    ...
    protected void doResize(int index, int w, int h, boolean finish){
        ...
        if(xbox!=null){
            ...
            if(crossWord && index==1){
                ...
                Rectangle r=new Rectangle((int)bg[index].getX(), (int)bg[index].getY(),
                w*ncw, h*nch);
                xbox.setBounds(r);
            }
            if(finish){
            ...
            switch(e.getID()){
                case KeyEvent.KEY_PRESSED:
                    switch(e.getKeyCode()){
                        ...
                        case KeyEvent.VK_BACK_SPACE: dx=-1; delete=true; moveFirst=true; break;
