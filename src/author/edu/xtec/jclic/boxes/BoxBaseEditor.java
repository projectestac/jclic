...
public class BoxBaseEditor extends javax.swing.JPanel {
  ...
  private void checkAndFirePropertyChange(BoxBase oldBb) {
    ...
    boolean eq =
        ((oldBb == null && currentBb == null) || (oldBb != null && oldBb.equals(currentBb)));
    if (!eq) firePropertyChange(PROP_BOX_BASE, oldBb, currentBb);
  }
  ...
  public BoxBase getBoxBaseClone() {
    if (bb != null) return (BoxBase) bb.clone();
    return null;
  }

  private static Map<Options, BoxBaseEditor> panels = new HashMap<Options, BoxBaseEditor>(1);

  public static BoxBase getBoxBase(
      BoxBase initialBoxBase, Component parent, Options options, final AbstractBox preview) {
      ...
      lst =
          new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent ev) {
              if (preview != null) preview.setBoxBase(bb_ed.getBoxBase());
            }
          };
    ...
    if (lst != null) bbe.removePropertyChangeListener(PROP_BOX_BASE, lst);
    if (!b && preview != null) preview.setBoxBase(bbBackup);
