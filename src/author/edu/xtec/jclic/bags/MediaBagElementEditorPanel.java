...
public class MediaBagElementEditorPanel extends EditorPanel {
  ...
  public MediaBagElementEditorPanel(Options options) {
    ...
    initComponents();
    refList.addListSelectionListener(
  ...
  private void initComponents() {
    ...
    chFileBtn.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/file_open.gif"))); // NOI18N
    ...
    saveFileBtn.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/file_save.gif"))); // NOI18N
    ...
    refreshFileBtn.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/reset.gif"))); // NOI18N
    ...
    refPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(options.getMsg("edit_media_referencedBy")));
  ...
  private void refListMouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_refListMouseClicked
  ...
  protected void fillData() {
    ...
    fileSystem =
        (mbed == null || mbed.getMediaBag() == null
            ? null
            : mbed.getMediaBag().getProject().getFileSystem());
  ...
  private void saveFile() {
    if (zipEntry != null) {
      ...
      String fNameDest =
          zipFileSystem.chooseFile(fName, true, null, options, "FILE_SAVE", this, false);
      if (fNameDest != null) {
        try {
          ...
          StreamIO.writeStreamDlg(
              is, os, len, options.getMessages().get("filesystem_copyFile"), this, options);
        } catch (Exception ex) {
  ...
  private void changeFileName() {
    ...
    if (mbed != null) {
      ...
      String newFileName =
          fs.chooseFile(
              oldFileName.replace('/', File.separatorChar),
              false,
              fileFilters,
              options,
              "edit_find_media",
  ...
  private void changeName() {
    ...
    if (mbed != null) {
      ...
      final String newName =
          msg.showInputDlg(
              MediaBagElementEditorPanel.this,
              "edit_media_rename",
  ...
  private void notifyChangesToParentPanel() {
    MediaBagMultiEditorPanel mbep =
        (MediaBagMultiEditorPanel) getAWTAncestor(MediaBagMultiEditorPanel.class);
    if (mbep != null) {
