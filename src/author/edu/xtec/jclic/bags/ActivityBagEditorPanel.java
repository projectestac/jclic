...
public class ActivityBagEditorPanel extends EditorPanel implements ListSelectionListener {
  ...
  public void setEnabled(boolean enabled) {
    ...
    if (currentPanel != null) currentPanel.setEnabled(enabled);
  }
  ...
  public void focusGained(FocusEvent focusEvent) {
    if (currentPanel != null) currentPanel.focusGained(focusEvent);
    else Editor.clearBasicActionsOwner();
  }

  @Override
  public void focusLost(FocusEvent focusEvent) {
    if (currentPanel != null) currentPanel.focusLost(focusEvent);
  }
