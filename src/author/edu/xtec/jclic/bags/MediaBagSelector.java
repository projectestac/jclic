...
public class MediaBagSelector extends javax.swing.JPanel {
  ...
  private void previewLabelMousePressed(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_previewLabelMousePressed

    if (current != null) current.testMedia(this, options);
  } // GEN-LAST:event_previewLabelMousePressed

  private void addMediaBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_addMediaBtnActionPerformed
  ...
  protected void setSelected(MediaBagElementEditor mbed) {
    ...
    long fSize = -1;
    if (mbed != null) fSize = mbed.getFileSize();
    ...
    previewLabel.setIcon(
        mbed == null
            ...
            : mbed.getMediaBagElement()
                .getThumbNail(90, 90, mbed.getMediaBag().getProject().getFileSystem()));
    if (mbed != null) mbed.getMediaBagElement().clearData();
  }
  ...
  private static Map<Options, MediaBagSelector> dlgPanels =
      new HashMap<Options, MediaBagSelector>(1);
  ...
  public static String getMediaName(
    ...
    if (mbs == null) {
      ...
      // mbs.setPreferredSize(new java.awt.Dimension(400, 300));
