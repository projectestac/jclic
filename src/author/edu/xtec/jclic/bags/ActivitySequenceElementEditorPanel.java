...
public class ActivitySequenceElementEditorPanel extends EditorPanel {
  ...
  private static final String[]
      ...
      FWD_OPTIONS_ICONS =
          {"seq_next", "seq_next_jump", "seq_next_stop", "seq_next_return", "seq_exit"},
      BACK_OPTIONS_KEYS =
          {
      ...
      BACK_OPTIONS_ICONS =
          {"seq_prev", "seq_prev_jump", "seq_prev_stop", "seq_prev_return", "seq_exit"};
  ...
  private void initComponents() {
    ...
    editActBtn.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/miniclic.png"))); // NOI18N
    ...
    fwdPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(options.getMsg("edit_seq_arrow_fwd")));
    fwdPanel.setLayout(new java.awt.GridBagLayout());

    fwIcon.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/next.gif"))); // NOI18N
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
    ...
    condJumpPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(options.getMsg("edit_seq_condJump")));
    ...
    backPanel.setBorder(
        javax.swing.BorderFactory.createTitledBorder(options.getMsg("edit_seq_arrow_back")));
    backPanel.setLayout(new java.awt.GridBagLayout());

    bkIcon.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/prev.gif"))); // NOI18N
    gridBagConstraints = new java.awt.GridBagConstraints();
    gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
    gridBagConstraints.insets = new java.awt.Insets(2, 2, 2, 2);
  ...
  protected ActivitySequenceElement getActivitySequenceElement() {
    ...
    else return ((ActivitySequenceElementEditor) editor).getActivitySequenceElement();
  }
  ...
  protected void fillData() {
    ...
    JClicProjectEditor jcpe =
        ase == null ? null : ((ActivitySequenceElementEditor) getEditor()).getProjectEditor();
    if (jcpe != null) {
    ...
    fwdEnabledChk.setSelected(
        ase == null ? true : (ase.navButtons & ActivitySequenceElement.NAV_FWD) != 0);
    fwdActionCombo.setSelectedIndex(
        (ase == null || ase.fwdJump == null) ? 0 : ase.fwdJump.action + 1);

    backEnabledChk.setSelected(
        ase == null ? true : (ase.navButtons & ActivitySequenceElement.NAV_BACK) != 0);
    backActionCombo.setSelectedIndex(
        (ase == null || ase.backJump == null) ? 0 : ase.backJump.action + 1);
    ...
    ((CondJumpBtn) upperBtn)
        .setConditionalJumpInfo(ase == null || ase.fwdJump == null ? null : ase.fwdJump.upperJump);
    ((CondJumpBtn) lowerBtn)
        .setConditionalJumpInfo(ase == null || ase.fwdJump == null ? null : ase.fwdJump.lowerJump);
  ...
  public boolean eventPerformed(EventObject ev) {
    ...
    ActivitySequenceElement ase = getActivitySequenceElement();
    if (src == null || ase == null) return false;
    if (src == tagCombo) {
      ...
      ase.fwdJump =
          (ActivitySequenceJump) checkJump(ase.fwdJump, fwdActionCombo, true, src == fwdJumpBtn);
      setJumpLabels();
    } else if (src == backActionCombo || src == backJumpBtn) {
      ase.backJump =
          (ActivitySequenceJump) checkJump(ase.backJump, backActionCombo, true, src == backJumpBtn);
      setJumpLabels();
    }
  ...
  private void updateTable() {
    ...
    if (cnt != null) {
      ...
      saveData();
      int row =
          ((ActivitySequenceEditorPanel) cnt)
              .seqTable
              .getSelectionModel()
  ...
  protected JumpInfo checkJump(
      JumpInfo ji, JComboBox combo, boolean allowNull, boolean forcePrompt) {
    int offset = allowNull ? 1 : 0;
    int v = combo.getSelectedIndex();
    if (v == 0 && allowNull) ji = null;
    else {
      if (ji == null) ji = new ActivitySequenceJump(v - offset);
      else ji.action = v - offset;
      if (ji.action == JumpInfo.JUMP
          && (forcePrompt || (ji.sequence == null && ji.projectPath == null))) {
        boolean b = promptJumpParams(ji, this);
        if (!b || (ji.sequence == null && ji.projectPath == null)) {
          if (allowNull) ji = null;
          else ji.action = JumpInfo.RETURN;
          setInitializing(true);
  ...
  protected void saveData() {
    ...
    if (ase != null && abed != null) {
      ...
      if (!StrUtils.compareObjects(tag, ase.getTag())) {
        ...
        ase.setTag(tag);
        if (tag != null && ased != null && ased.tagList != null) ased.tagList.addElement(tag);
      }
      ...
      if (jcpe != null) {
        ...
        result =
            options
                .getMessages()
                .showInputDlg(
                    parent, prompt_msg, prompt_keys, prompt_objects, "edit_seq_jump_title");
  ...
  private void setJumpLabels() {
    ...
    if (ase != null && ase.fwdJump != null) {
      if (ase.fwdJump.sequence != null) sb.append(ase.fwdJump.sequence);
    ...
    if (ase != null && ase.backJump != null) {
      if (ase.backJump.sequence != null) sb.append(ase.backJump.sequence);
  ...
  class CondJumpBtn extends NullableObject {
    ...
    protected Object editObject(Object o) {
      ...
      boolean b =
          options
              .getMessages()
              .showInputDlg(this, cjp, "edit_seq_condJump_" + (upper ? "upper" : "lower"));
    ...
    private void checkIcon() {
      ...
      if (o == null || fwdIcons == null) setIcon(null);
      else setIcon(fwdIcons[o.action + 1]);
      repaint();
    }
  }
