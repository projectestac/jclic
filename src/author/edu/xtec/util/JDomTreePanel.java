...
public class JDomTreePanel extends javax.swing.JPanel {
  ...
  public JDomTreePanel(
      org.jdom.Element element, ResourceBridge rb, FileSystem fs, String fileName) {
    this.rb = rb;
    this.fs = fs;
  ...
  private void checkEnabled() {
    ...
    if (currentNode == null) {
      ...
      pasteBtn.setEnabled(
          clip != null && empty && clip != currentNode && !clip.isNodeChild(currentNode));
    }
  }
  ...
  private void initComponents() { // GEN-BEGIN:initComponents
    ...
    newElementBtn.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/new_element.gif")));
    newElementBtn.setToolTipText(rb.getMsg("XML_NEW_ELEMENT"));
    newElementBtn.setEnabled(false);
    newElementBtn.addActionListener(
    ...
    delElementBtn.setEnabled(false);
    delElementBtn.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    pasteBtn.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/paste.gif")));
    ...
    cutBtn.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/edu/xtec/resources/icons/cut.gif")));
    ...
    saveBtn.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/file_save.gif")));
    ...
    newAttributeBtn.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/edu/xtec/resources/icons/new_attribute.gif")));
    newAttributeBtn.setToolTipText(rb.getMsg("XML_NEW_ATTRIBUTE"));
    newAttributeBtn.setEnabled(false);
    newAttributeBtn.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void cutBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_cutBtnActionPerformed
  ...
  private void pasteBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_pasteBtnActionPerformed
  ...
  private void saveBtnActionPerformed(
    ...
    if (fs == null) fs = new FileSystem(rb);

    int[] filters = {Utils.JCLIC_FF};
    String result =
        fs.chooseFile(fileName + ".jclic", true, filters, rb.getOptions(), null, this, false);
    if (result != null) {
      ...
      try {
        ...
        rb.getOptions()
            .getMessages()
            .showErrorWarning(this, "FILE_ERR_SAVING", fullFileName, ex, null);
      }
    }
  } // GEN-LAST:event_saveBtnActionPerformed

  private void delElementBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_delElementBtnActionPerformed

    if (currentNode != null && current != null && !current.getElement().isRootElement()) {
      if (clip == currentNode) clip = null;
  ...
  private void newElementBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_newElementBtnActionPerformed
    ...
    if (currentNode != null && current != null) {
      ...
      if (s == null || s.length() == 0) {
        ...
        for (int i = 0; i < fields.length; i++) fields[i].setPreferredSize(dim);
        String[] promptKeys = new String[] {"XML_NAME"};
        if (rb.getOptions()
            .getMessages()
            .showInputDlg(JDomTreePanel.this, null, promptKeys, fields, "XML_NEW_ELEMENT")) {
          ...
          if (elementName != null && elementName.length() > 0) {
            ...
            ((DefaultTreeModel) tree.getModel())
                .insertNodeInto(node, currentNode, currentNode.getChildCount());
            setTableModel();
          }
        }
      }
  ...
  private void delAttributeBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_delAttributeBtnActionPerformed
    ...
    if (current != null) {
      ...
      if (r >= 0) {
        if (r == 0) {
          ...
          for (Object o : ls) {
            if (o instanceof org.jdom.Text) toRemove.add((org.jdom.Text) o);
          }
          ls.removeAll(toRemove);
        } else {
          String s = (String) current.getValueAt(r, 0);
          if (s != null) current.getElement().removeAttribute(s);
        }
        setTableModel();
      }
    }
  ...
  private void newAttributeBtnActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_newAttributeBtnActionPerformed
    ...
    if (current != null) {
      ...
      if (rb.getOptions()
          .getMessages()
          .showInputDlg(JDomTreePanel.this, null, promptKeys, fields, "XML_NEW_ATTRIBUTE")) {
  ...
  public static org.jdom.Element editElement(
      Component parent,
      org.jdom.Element element,
      ResourceBridge rb,
      FileSystem fs,
    ...
    boolean b =
        rb.getOptions()
            .getMessages()
            .showInputDlg(parent, new JDomTreePanel(clon, rb, fs, fileName), titleKey);
    return b ? clon : null;
  }
